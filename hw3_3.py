...
def normalize_phone(phone_number):
    cleaned_phone_number = re.sub(r'[^\+0-9]', '', phone_number)                        # delete all except "+, 0-9"
    if not cleaned_phone_number.startswith('+'):                                        # if have not "+"        
         if cleaned_phone_number.startswith('380'):                                     # if have "380"
             cleaned_phone_number = '+' + cleaned_phone_number                          # add "+"
         else:
            cleaned_phone_number = '+38' + cleaned_phone_number                         # else add "+38"
    return cleaned_phone_number
   
sanitized_numbers = [normalize_phone(num) for num in raw_numbers]
print("Normalized phone numbers for SMS sending:", sanitized_numbers, sep='\n' )